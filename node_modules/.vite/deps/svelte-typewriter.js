import {
  concurrent_default
} from "./chunk-L5KZYLRT.js";
import {
  cascade_default
} from "./chunk-GVSPORFH.js";
import {
  loop_default
} from "./chunk-BMYRQQDH.js";
import {
  loopOnce_default
} from "./chunk-KWE6Z5UR.js";
import {
  loopRandom_default
} from "./chunk-KGCRGK7X.js";
import "./chunk-FRXHI2OO.js";
import "./chunk-W6PAD6CQ.js";
import "./chunk-2RGK4MA3.js";
import {
  scramble_default
} from "./chunk-GFTY2LNN.js";
import "./chunk-C2FKSMMI.js";
...
function add_css(target) {
  append_styles(target, "svelte-1gv2i7t", "@keyframes svelte-1gv2i7t-cursorFade{0%,100%{opacity:1}50%{opacity:0}}.typewriter-container.svelte-1gv2i7t *:not(.typing):not(.finished-typing):not([data-static]){display:none}.typewriter-container.svelte-1gv2i7t .finished-typing::after{content:none}.cursor.svelte-1gv2i7t .typing::after{content:'';width:var(--cursor-width, 1ch);height:2ch;display:inline-block;vertical-align:text-top;background-color:var(--cursor-color, #000000);animation:svelte-1gv2i7t-cursorFade 1.25s infinite}\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */");
}
function create_else_block(ctx) {
  ...
  handle_promise(promise = /*delayPromise*/
  ctx[6](), info);
  const block = {
    c: function create() {
    ...
    p: function update(new_ctx, dirty) {
      ctx = new_ctx;
      info.ctx = ctx;
      if (dirty & /*delayPromise*/
      64 && promise !== (promise = /*delayPromise*/
...
function create_dynamic_element(ctx) {
  ...
  const block = {
    ...
    m: function mount(target, anchor) {
      ...
      current = true;
      if (!mounted) {
        dispose = action_destroyer(selectedMode_default_action = /*selectedMode*/
        ctx[25].default(
          svelte_element,
          /*props*/
          ctx[5]
    ...
    p: function update(ctx2, dirty) {
      ...
      if (selectedMode_default_action && is_function(selectedMode_default_action.update) && dirty & /*props*/
      32)
        selectedMode_default_action.update.call(
          null,
          /*props*/
          ctx2[5]
        );
      if (!current || dirty & /*cursor*/
      2) {
        toggle_class(
          svelte_element,
          "cursor",
...
function create_fragment(ctx) {
  ...
  const block = {
    ...
    p: function update(ctx2, [dirty]) {
      if (dirty & /*$$props*/
      256 && safe_not_equal(previous_key, previous_key = /*$$props*/
      ctx2[8])) {
        group_outros();
...
function instance($$self, $$props, $$invalidate) {
  ...
  const modes = {
    concurrent: () => import("./concurrent-ACSBRNLV.js"),
    cascade: () => import("./cascade-7VRI3R5T.js"),
    loop: () => import("./loop-ANTZ54L3.js"),
    loopOnce: () => import("./loopOnce-M7EVUBLP.js"),
    loopRandom: () => import("./loopRandom-43RMCJGG.js"),
    scramble: () => import("./scramble-CNASDQOA.js")
  };
  $$self.$$set = ($$new_props) => {
  ...
  $$self.$$.update = () => {
    ...
    if ($$self.$$.dirty & /*isFiniteCursorMode, keepCursorOnFinish*/
    4195328) {
      $:
        $$invalidate(20, invalidCursorOnFinish = !isFiniteCursorMode && keepCursorOnFinish);
    }
    if ($$self.$$.dirty & /*delay, showCursorOnDelay*/
    2052) {
      $:
    ...
    if ($$self.$$.dirty & /*invalidScrambleProps*/
    131072) {
      $:
    ...
    if ($$self.$$.dirty & /*unnecessaryCursorOnFinish*/
    65536) {
      $:
    ...
    if ($$self.$$.dirty & /*interval, cursor, keepCursorOnFinish, delay, showCursorOnDelay, disabled, element, scrambleDuration, scrambleSlowdown, unwriteInterval, wordInterval*/
    65054) {
      $:
        $$invalidate(5, props = {
          interval,
